"""YAML config templates for scaffolding new training runs.

Kept out of fine_tune_utils so that module stays about behaviour, not boilerplate.
Used by generate_custom_yaml_file / the generate_bert_model_config CLI command.
"""
