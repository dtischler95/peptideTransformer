...
class PeptideBertForConvBinaryClassification(BertModel):
    """
    ...
    def __init__(self, config,model_path: str,  bce_logit_weight, loss_function: str = 'bce'):
        ...
        self.classifier = nn.Linear(in_features=128, out_features=config.num_labels)
    ...
    def forward(
        ...
        last_hidden_state = outputs[0]  # [0] last_hidden_states [1] pooled_output
        x = last_hidden_state.permute(0, 2, 1)  # Change shape to (batch_size, hidden_size, seq_length)
